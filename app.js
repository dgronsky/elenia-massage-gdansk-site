...
const TRANSLATIONS = {
  ru: {
    ...
    "Wybierz czas dla siebie": "Выберите время для себя", "Pełna lista, ceny i aktualne terminy są zawsze dostępne w profilu Elenia na Booksy.": "Полный список услуг, цены и актуальные часы всегда доступны в профиле Elenia на Booksy.", "Masaż relaksacyjny": "Расслабляющий массаж", "Masaż klasyczny": "Классический массаж", "Plecy i kark": "Спина и шея", "Cena i terminy w Booksy": "Цены и часы в Booksy", "Spokojna sesja, która pomaga odetchnąć i odzyskać poczucie lekkości po intensywnym dniu.": "Спокойный сеанс, помогающий выдохнуть и почувствовать лёгкость после насыщенного дня.", "Sesja dopasowana do codziennego napięcia i indywidualnych oczekiwań klienta.": "Сеанс, подобранный с учётом повседневного напряжения и индивидуальных ожиданий клиента.", "Uważna praca z obszarami, które najczęściej odczuwają skutki siedzącego trybu życia.": "Внимательная работа с зонами, которые чаще всего страдают от сидячего образа жизни.",
    ...
    "Rezerwacja": "Запись", "Znajdź dogodny termin": "Найдите удобное время", "Usługi, ceny i aktualna dostępność są widoczne w Booksy. Rezerwacja zajmuje tylko chwilę.": "Услуги, цены и актуальная доступность видны в Booksy. Запись займёт всего минуту.", "Gabinet znajduje się przy ul. Ogarnej 3/4, w lokalu 3 — w dzielnicy Śródmieście, na Głównym Mieście. Wizyta odbywa się po wcześniejszej rezerwacji.": "Кабинет находится на ул. Огарной 3/4, помещение 3, в районе Срудмесьце, в Главном городе. Приём только по предварительной записи.", "Zdjęcia, aktualności i kontakt": "Фотографии, новости и контакты", "Ogarna 3/4, lok. 3 • tylko po wcześniejszej rezerwacji": "Огарна 3/4, пом. 3 • только по предварительной записи", "Wkrótce": "Скоро", "Link do Instagramu lub Facebooka zostanie dodany po uruchomieniu oficjalnych stron.": "Ссылка на Instagram или Facebook будет добавлена после запуска официальных страниц.",
    ...
    "Alena ukończyła szkołę policealną na kierunku masażu, ma wykształcenie pielęgniarskie i ponad trzy lata doświadczenia. Obsługuje po polsku i rosyjsku; podstawowa komunikacja jest możliwa także po angielsku. Rozumie ukraiński, ale nie prowadzi obsługi w tym języku. Każde spotkanie rozpoczyna od krótkiej rozmowy, aby dopasować przebieg sesji do oczekiwań i komfortu klienta.": "Алена окончила в Польше полицеальную школу по массажу, имеет образование медсестры и более трёх лет опыта. Обслуживает на польском и русском языках; базовое общение возможно также на английском. Алена понимает украинский, но не ведёт обслуживание на этом языке. Каждая встреча начинается с короткой беседы, чтобы адаптировать ход сеанса к ожиданиям и комфорту клиента."
  },
  uk: {
    ...
    "Wybierz czas dla siebie": "Оберіть час для себе", "Pełna lista, ceny i aktualne terminy są zawsze dostępne w profilu Elenia na Booksy.": "Повний перелік послуг, ціни й актуальний час завжди доступні у профілі Elenia на Booksy.", "Masaż relaksacyjny": "Релаксувальний масаж", "Masaż klasyczny": "Класичний масаж", "Plecy i kark": "Спина й шия", "Cena i terminy w Booksy": "Ціни й час у Booksy", "Spokojna sesja, która pomaga odetchnąć i odzyskać poczucie lekkości po intensywnym dniu.": "Спокійний сеанс, що допомагає видихнути й відчути легкість після насиченого дня.", "Sesja dopasowana do codziennego napięcia i indywidualnych oczekiwań klienta.": "Сеанс, підібраний до щоденної напруги та індивідуальних очікувань клієнта.", "Uważna praca z obszarami, które najczęściej odczuwają skutki siedzącego trybu życia.": "Уважна робота з ділянками, які найчастіше відчувають наслідки сидячого способу життя.",
    ...
    "Rezerwacja": "Бронювання", "Znajdź dogodny termin": "Знайдіть зручний час", "Usługi, ceny i aktualna dostępność są widoczne w Booksy. Rezerwacja zajmuje tylko chwilę.": "Послуги, ціни й актуальна доступність показані в Booksy. Бронювання займе лише мить.", "Gabinet znajduje się przy ul. Ogarnej 3/4, w lokalu 3 — w dzielnicy Śródmieście, na Głównym Mieście. Wizyta odbywa się po wcześniejszej rezerwacji.": "Кабінет розташований на вул. Огарній 3/4, приміщення 3, у районі Середмістя, в Головному місті. Прийом за попереднім записом.", "Zdjęcia, aktualności i kontakt": "Фото, новини й контакти", "Ogarna 3/4, lok. 3 • tylko po wcześniejszej rezerwacji": "Огарна 3/4, прим. 3 • лише за попереднім записом", "Wkrótce": "Незабаром", "Link do Instagramu lub Facebooka zostanie dodany po uruchomieniu oficjalnych stron.": "Посилання на Instagram або Facebook буде додано після запуску офіційних сторінок.",
    ...
    "Alena ukończyła szkołę policealną na kierunku masażu, ma wykształcenie pielęgniarskie i ponad trzy lata doświadczenia. Obsługuje po polsku i rosyjsku; podstawowa komunikacja jest możliwa także po angielsku. Rozumie ukraiński, ale nie prowadzi obsługi w tym języku. Każde spotkanie rozpoczyna od krótkiej rozmowy, aby dopasować przebieg sesji do oczekiwań i komfortu klienta.": "Альона закінчила в Польщі післяліцейну школу за напрямом масажу, має освіту медсестри та понад три роки досвіду. Обслуговує польською й російською; базове спілкування можливе також англійською. Альона розуміє українську, але не проводить обслуговування українською. Кожна зустріч починається з короткої розмови, щоб адаптувати сеанс до очікувань і комфорту клієнта."
  },
  be: {
    ...
    "Wybierz czas dla siebie": "Выберыце час для сябе", "Pełna lista, ceny i aktualne terminy są zawsze dostępne w profilu Elenia na Booksy.": "Поўны спіс паслуг, цэны і актуальны час заўсёды даступныя ў профілі Elenia на Booksy.", "Masaż relaksacyjny": "Расслабляльны масаж", "Masaż klasyczny": "Класічны масаж", "Plecy i kark": "Спіна і шыя", "Cena i terminy w Booksy": "Цэны і час у Booksy", "Spokojna sesja, która pomaga odetchnąć i odzyskać poczucie lekkości po intensywnym dniu.": "Спакойны сеанс, які дапамагае выдыхнуць і адчуць лёгкасць пасля насычанага дня.", "Sesja dopasowana do codziennego napięcia i indywidualnych oczekiwań klienta.": "Сеанс, падабраны да штодзённага напружання і індывідуальных чаканняў кліента.", "Uważna praca z obszarami, które najczęściej odczuwają skutki siedzącego trybu życia.": "Уважлівая праца з зонамі, якія часцей за ўсё адчуваюць наступствы сядзячага ладу жыцця.",
    ...
    "Rezerwacja": "Браніраванне", "Znajdź dogodny termin": "Знайдзіце зручны час", "Usługi, ceny i aktualna dostępność są widoczne w Booksy. Rezerwacja zajmuje tylko chwilę.": "Паслугі, цэны і актуальная даступнасць паказаны ў Booksy. Браніраванне зойме толькі хвіліну.", "Gabinet znajduje się przy ul. Ogarnej 3/4, w lokalu 3 — w dzielnicy Śródmieście, na Głównym Mieście. Wizyta odbywa się po wcześniejszej rezerwacji.": "Кабінет знаходзіцца на вул. Огарнай 3/4, памяшканне 3, у раёне Сярэдмесце, у Галоўным горадзе. Прыём па папярэднім запісе.", "Zdjęcia, aktualności i kontakt": "Фота, навіны і кантакты", "Ogarna 3/4, lok. 3 • tylko po wcześniejszej rezerwacji": "Огарна 3/4, пам. 3 • толькі па папярэднім запісе", "Wkrótce": "Хутка", "Link do Instagramu lub Facebooka zostanie dodany po uruchomieniu oficjalnych stron.": "Спасылка на Instagram або Facebook будзе дададзена пасля запуску афіцыйных старонак.",
    ...
    "Alena ukończyła szkołę policealną na kierunku masażu, ma wykształcenie pielęgniarskie i ponad trzy lata doświadczenia. Obsługuje po polsku i rosyjsku; podstawowa komunikacja jest możliwa także po angielsku. Rozumie ukraiński, ale nie prowadzi obsługi w tym języku. Każde spotkanie rozpoczyna od krótkiej rozmowy, aby dopasować przebieg sesji do oczekiwań i komfortu klienta.": "Алена скончыла ў Польшчы пасляліцэйскую школу па масажы, мае адукацыю медсястры і больш за тры гады досведу. Абслугоўвае па-польску і па-руску; базавыя зносіны магчымыя таксама па-англійску. Алена разумее ўкраінскую, але не вядзе абслугоўванне на ёй. Кожная сустрэча пачынаецца з кароткай размовы, каб адаптаваць сеанс да чаканняў і камфорту кліента."
  }
};
